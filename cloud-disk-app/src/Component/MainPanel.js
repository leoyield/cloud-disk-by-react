...
class MainPanel extends Component {
    ...
    deleteFile(filename) {
        swal({
            title: "Are you sure?",
            text: "Youwill not be able to recover this file!",
            icon: "warning",
            buttons: true,
            dangerModel: true,
        })
        ...
        .then(response =>
            {
                if (response.ok) {
                    ...
                    this.refreshFileList();
                    swal('Your file state has been changed.', {
                        icon:'success'});
                }
            });
    }
                    ...
                    <Modal.Body>
                        <ListGroup>
                            <ListGroupItem>
                                <Row>
                                    <Col md={8}>
                                        <p>Public Share: {window.location + "s/" + this.state.selectedFile.public_share_url}</p>
                                    </Col>
                                    <Col md={2} mdOffset={2}>
                                ...
                                <Row>
                                    <Col md={8}>
                                        <p>Private Share: <a href={window.location + "s/" + this.state.selectedFile.private_share_url} target='_blank'>{window.location + "s/" + this.state.selectedFile.private_share_url}</a> , Password: {this.state.selectedFile.private_share_password} </p>
                                    </Col>
                                    <Col md={2} mdOffset={2}>
