const Api = {
    ...
    getFolders() {
        return fetch(this.BASE_API + "/folder", {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
            },
    ...
    getFolder(name) {
        return fetch(this.BASE_API + "/folder/" + name, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
            },
    ...
    uploadFile(folder,file) {
        ...
        return fetch(this.BASE_API + "/folder/" + folder, {
            method: 'POST',
            body: data,
            headers: {
                Accept: 'application/json',
    ...
    deleteFile(folder, filename) {
        return fetch(this.BASE_API + "/folder/" + folder +"/" +filename, {
            method: 'DELETE',
            headers: {
                'Accept': 'application/json',
            },
    ...
    generateFileDownloadUrl(folder, filename) {
        return this.BASE_API + "/folder/" + folder + "/" + filename;
    },
    ...
    updataFileShareType(folder, filename, shareType) {
        return fetch(this.BASE_API + "/folder/" + folder + "/" + filename + "?shareType=" + shareType,{
            method: 'PATCH',
            headers: {
                'Accept': 'application/json',
            },
